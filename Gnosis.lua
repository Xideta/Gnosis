...
function Gnosis:SetupChanneledSpellsTable()
	...
	if not (wowmainline) then
		...
		self:AddChanneledSpellById(263165, 3, false, 3, false, false, "shadow", false, 1); 	-- void torrent
	end
	...
	if not (wowmainline) then
		...
		self:AddChanneledSpellById(382440, 4, false, 4, false, true, "arcane", false, 1);	-- shifting power
		self:AddChanneledSpellById(205021, 5, false, 5, false, false, "frost", false, 1);	-- ray of frost
	end
	...
	if not (wowmainline) then
		...
		self:AddChanneledSpellById(196447, 15, false, 15, false, false, "fire", false, 1);	-- channel demonfire
	end
