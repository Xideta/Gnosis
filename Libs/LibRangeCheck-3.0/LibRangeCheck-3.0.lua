...
local GetNumSpellTabs = C_SpellBook.GetNumSpellBookSkillLines or C_SpellBook.GetNumSpellBookSkillLines
local GetSpellTabInfo = C_SpellBook.GetSpellBookSkillLineInfo or function(index)
